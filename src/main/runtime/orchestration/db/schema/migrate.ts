...
import { applySchemaMigrationsV31ToV33 } from './migrate-v31-v33'
import { applySchemaMigrationV34 } from './migrate-v34'
...
export function migrate(this: OrchestrationDb): void {
  ...
  try {
    ...
    applySchemaMigrationsV31ToV33.call(this, current)
